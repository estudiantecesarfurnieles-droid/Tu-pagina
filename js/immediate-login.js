/**
 * 💖 SISTEMA DE LOGIN INMEDIATO 💖
 * Versión que funciona inmediatamente sin depender de APIs
 */
...
document.addEventListener('DOMContentLoaded', () => {
    new ImmediateLoginSystem();
});

// Exportar para uso global
window.LoginSystem = ImmediateLoginSystem;
